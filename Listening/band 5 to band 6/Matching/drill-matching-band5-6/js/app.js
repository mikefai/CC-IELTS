(function(){
  ...
  qs.forEach(function(item,i){
    ...
    d.innerHTML='<div style="font-weight:700;margin-bottom:.4rem">'+item.q+'</div>' + item.opts.map(function(o,j){var v=String.fromCharCode(65+j); return '<label style="display:block;margin:.3rem 0;cursor:pointer"><input type="radio" name="q'+i+'" value="'+v+'"> '+o+'</label>';}).join('');
    el.appendChild(d);
  });
